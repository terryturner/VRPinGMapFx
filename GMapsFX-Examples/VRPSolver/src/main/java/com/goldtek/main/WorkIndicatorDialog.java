...
public class WorkIndicatorDialog<P> {
    ...
    private enum State { INVISIBLE, VISIBLE, EXCEPTION };
    ...
    public void setResult(boolean success) {
        mState = success ? State.INVISIBLE : State.EXCEPTION;
    }

    public boolean isVisible() {
        return (mState.equals(State.VISIBLE));
    }
    
    public boolean isException() {
        return (mState.equals(State.EXCEPTION));
    }
}