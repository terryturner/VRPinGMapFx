...
//        this.mapMarker = mapMarker;
    ...
    public MapOptions defaultUIControl( boolean defaultUIControl ) {
        setProperty( "disableDefaultUI", !defaultUIControl );
        this.disableDefaultUI = !defaultUIControl;
        return this;
    }
    
    public MapOptions draggableControl( boolean draggable ) {
        setProperty( "draggable", draggable );
        this.draggable = draggable;
        return this;
    }
    
    public MapOptions scrollwheelControl( boolean scrollwheel ) {
        setProperty( "scrollwheel", scrollwheel );
        this.scrollwheel = scrollwheel;
        return this;
    }
    
    public MapOptions doubleClickZoomControl( boolean doubleClickZoom ) {
        setProperty( "disableDoubleClickZoom", !doubleClickZoom );
        this.disableDoubleClickZoom = !doubleClickZoom;
        return this;
    }
}
